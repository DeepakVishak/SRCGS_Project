...
class Home_Page_GUI:
    ...
    def __init__(self,window):
        ...
        #About and Help
        ins=Button(window,fg='blue',text='About and Help...',command=lambda: self.action_about_help() ,font='20',padx='10')
        ...
        mesg=Label(window,text='* All Fields are Mandatory \n * Read instructions carefully from about and help before processing if you are new.',fg='red',font='20').grid(row=11,column=1,ipady=20)

        #showing rights
        Rights=Label(window,text='© All rights reserved.DeepakV ICFOSS Project',height=10).grid(row=12,column=1)
    ...
    def action_about_help(self):
        ...
        subprocess.Popen('about_help.py',shell=True)
