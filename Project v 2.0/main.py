...
class Home_Page_GUI:
    ...
    def __init__(self,window):
        ...
        #About and Help
        ins=Label(window,fg='blue',text='About and Help...',font='20',padx='10')
        ...
        mesg=Label(window,text='* All Fields are Mandatory',fg='red',font='20').grid(row=11,column=1,ipady=5)
